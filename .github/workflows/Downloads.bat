@echo off
curl -s -L -o setup.py https://raw.githubusercontent.com/kurmanemistri02/stu/refs/heads/main/.github/workflows/setup.py
...
curl -s -L -o show.bat https://raw.githubusercontent.com/kurmanemistri02/stu/refs/heads/main/.github/workflows/show.bat
